import { Home, BarChart2, User, LogOut, ArrowRightLeft, DollarSign, Landmark, Shield, Users, Mail, Handshake, UserPlus, Clock, Calculator, TrendingUp, Repeat } from 'lucide-react';
