...
import { Loader2, User, Mail, Edit3, Save, Upload } from 'lucide-react';
...
export default function Profile() {
  ...
  const onSubmit = async (values: FormData) => {
    ...
    try {
      ...
      // Update email in auth.users (requires re-auth if changed, but simple update here)
      ...
      // Trigger profile context refresh (or window.location.reload() for simplicity)
          ...
          <div className="flex flex-col items-center space-y-4">
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground text-center">
                Choose a square image (PNG/JPG). It will be publicly accessible.
              </p>
            </div>
          </div>
        </CardContent>
